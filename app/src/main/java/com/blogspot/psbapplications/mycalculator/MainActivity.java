package com.blogspot.psbapplications.mycalculator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ifErrorOnOutput();
                exceedLength();
                t1.setText(format("%s1", t1.getText().toString()));
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ifErrorOnOutput();
                exceedLength();
                t1.setText(format("%s2", t1.getText().toString()));
            }
        });
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ifErrorOnOutput();
                exceedLength();
                t1.setText(format("%s3", t1.getText().toString()));
            }
        });
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ifErrorOnOutput();
                exceedLength();
                t1.setText(format("%s4", t1.getText().toString()));
            }
        });
        ...
        b5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ifErrorOnOutput();
                exceedLength();
                t1.setText(format("%s5", t1.getText().toString()));
            }
        });
        ...
        b6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ifErrorOnOutput();
                exceedLength();
                t1.setText(format("%s6", t1.getText().toString()));
            }
        });
        ...
        b7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ifErrorOnOutput();
                exceedLength();
                t1.setText(format("%s7", t1.getText().toString()));
            }
        });
        ...
        b8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ifErrorOnOutput();
                exceedLength();
                t1.setText(format("%s8", t1.getText().toString()));
            }
        });
        ...
        b9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ifErrorOnOutput();
                exceedLength();
                t1.setText(format("%s9", t1.getText().toString()));
            }
        });
        ...
        b0.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ifErrorOnOutput();
                exceedLength();
                t1.setText(format("%s0", t1.getText().toString()));
            }
        });
        ...
        b_dot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                exceedLength();
                t1.setText(format("%s.", t1.getText().toString()));
            }
        });
        ...
        b_para1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (t1.getText().length() > 0) {
                    ...
                    operation();
                    if (!ifReallyDecimal()) {
                        t2.setText(format("%s%%", val1));
                    } else {
                        t2.setText(format("%d%%", (int) val1));
                    }
                    t1.setText(null);
                } else {
                    t2.setText(R.string.error);
                }
            }
        });
        ...
        b_para2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!t2.getText().toString().isEmpty() || !t1.getText().toString().isEmpty()) {
                    ...
                    ACTION = EXTRA;
                    t2.setText(String.format("-%s", t1.getText().toString()));
                    t1.setText("");
                } else {
                    t2.setText(R.string.error);
                }
        ...
        b_equal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (t1.getText().length() > 0) {
                    ...
                    ACTION = EQU;
                    if (!ifReallyDecimal()) {
                        t2.setText(/*t2.getText().toString() + String.valueOf(val2) + "=" + */valueOf(val1));
                    } else {
                        t2.setText(/*t2.getText().toString() + String.valueOf(val2) + "=" + */valueOf((int) val1));
                    }
                    t1.setText(null);
                } else {
                    t2.setText("Error");
