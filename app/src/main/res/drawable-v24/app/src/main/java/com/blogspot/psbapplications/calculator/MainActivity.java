package com.blogspot.psbapplications.calculator;
...
import com.blogspot.psbapplications.calculator.ui.main.MainFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ifErrorOnOutput();
                exceedLength();
                t1.setText(String.format("%s2", t1.getText().toString()));
            }
        });
